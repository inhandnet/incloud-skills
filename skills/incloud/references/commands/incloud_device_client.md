## incloud device client

Connected clients (Wi-Fi/LAN)

### Synopsis

List, inspect, and monitor clients connected to your devices.
...
* [incloud device client datausage-daily](incloud_device_client_datausage-daily.md)	 - Client daily data usage
* [incloud device client datausage-hourly](incloud_device_client_datausage-hourly.md)	 - Client hourly data usage
* [incloud device client get](incloud_device_client_get.md)	 - Get client details
* [incloud device client list](incloud_device_client_list.md)	 - List connected clients
* [incloud device client mark-asset](incloud_device_client_mark-asset.md)	 - Mark clients as assets
